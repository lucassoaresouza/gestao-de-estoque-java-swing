...
public class removeProductFromStockTest {
    ...
    public void setUp() {
        ...
        prod1 = new Product(1,"Cafe","Po de cafe");
        prod2 = new Product(2,"Cha","Po de cha");
        prod3 = new Product(3,"Achocolatado","Po de chocolate ao leite");
        prod4 = new Product(4,"Arroz","Graos de Arroz");
        prod5 = new Product(5, "Chafe", "Cha de cafe");
